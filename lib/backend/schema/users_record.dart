...
class UsersRecord extends FirestoreRecord {
  ...
  // "ParkingaddRef" field.
  DocumentReference? _parkingaddRef;
  DocumentReference? get parkingaddRef => _parkingaddRef;
  bool hasParkingaddRef() => _parkingaddRef != null;
  ...
  void _initializeFields() {
    ...
    _parkingaddRef = snapshotData['ParkingaddRef'] as DocumentReference?;
...
Map<String, dynamic> createUsersRecordData({
  ...
  String? phoneNumber,
  DocumentReference? parkingaddRef,
...
class UsersRecordDocumentEquality implements Equality<UsersRecord> {
  ...
  bool equals(UsersRecord? e1, UsersRecord? e2) {
    return e1?.email == e2?.email &&
        ...
        e1?.parkingaddRef == e2?.parkingaddRef &&
