...
class _EditProfileWidgetState extends State<EditProfileWidget> {
  ...
  void initState() {
    ...
    _model.plateNumberTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.plateNumber, ''));
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: Align(
          ...
          child: Padding(
            padding: EdgeInsetsDirectional.fromSTEB(10.0, 25.0, 19.0, 0.0),
            child: Column(
              mainAxisSize: MainAxisSize.max,
              children: [
                Padding(
                ...
                Padding(
                  ...
                  child: AuthUserStreamWidget(
                    builder: (context) => TextFormField(
                      ...
                      obscureText: false,
                      decoration: InputDecoration(
                        labelText: 'Plate Number, ex..AAA1111',
                        labelStyle:
                            FlutterFlowTheme.of(context).labelMedium.override(
                                  fontFamily: 'Readex Pro',
                                  letterSpacing: 0.0,
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      await currentUserReference!.update(createUsersRecordData(
                        ...
                        plateNumber: _model.plateNumberTextController.text,
                      ));
                      context.safePop();
                    },
                    text: 'Save Changes',
