...
import 'add_p_arking_model.dart';
export 'add_p_arking_model.dart';
                    ...
                    Column(
                      ...
                      children: [
                              ...
                              children: [
                                Flexible(
                                  child: Align(
                                    ...
                                    child: Text(
                                      'This is Parking Number: ${_model.radioButtonValue != null && _model.radioButtonValue != '' ? valueOrDefault<String>(
                                          (scrollingColumnCount + 1).toString(),
                                          'Choose The Location!',
                                        ) : 'Choose The Location!'}',
                                      maxLines: 3,
                        ...
                        TextFormField(
                          ...
                          obscureText: false,
                          decoration: InputDecoration(
                            labelText: 'Parking Location Description',
                            labelStyle: FlutterFlowTheme.of(context)
                                .headlineSmall
                                .override(
                                  fontFamily: 'Outfit',
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: !((_model.textController1.text != null &&
                            ...
                            ? null
                            : () async {
                                var parkingRecordReference =
                                    ParkingRecord.collection.doc();
                                await parkingRecordReference.set({
                                  ...createParkingRecordData(
                                    parkingNumber: scrollingColumnCount + 1,
                                    price: double.tryParse(
                                        _model.textController1.text),
                                    location: _model.radioButtonValue,
                                    adminParkinAdd: currentUserReference,
                                    parkingURL: _model.textController2.text,
                                    parkingdescription:
                                        _model.textController3.text,
                                    isAvalibale: functions.isItAvalible(),
                                  ),
                                  ...mapToFirestore(
                                    {
                                      'availability':
                                          getAvailabilityListFirestoreData(
                                        functions.initalAvaliablity(),
                                      ),
                                    },
                                  ),
                                });
                                _model.classoutput =
                                    ParkingRecord.getDocumentFromData({
                                  ...createParkingRecordData(
                                    parkingNumber: scrollingColumnCount + 1,
                                    price: double.tryParse(
                                        _model.textController1.text),
                                ...
                                await currentUserReference!
                                  ...
                                  parkingaddRef: _model.classoutput?.reference,
                                ));
